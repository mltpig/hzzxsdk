...
declare namespace BK {
    ...
    export class HttpUtil {
        ...
        requestAsync(callback: (res, code) => void): void;
    ...
    export class FileUtil {
        ...
        static writeFile(path: string, buff: string): void;
    ...
    export class QQ {
         ...
         * 多渠道分享
         */
        static share(shareInfo: Object, callbck: (retCode: number, shareDest: number, isFirstShare: number) => void);
